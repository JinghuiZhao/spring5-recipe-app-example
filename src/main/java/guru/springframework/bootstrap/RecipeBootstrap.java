...
// note that we use spring event to
@Component
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    } // this is the essential part where we return the recipes to the repo
    // we for this repository we create the implementation of the service where the
    //reposirtory will be injected through the contructor and we convert the iterable into
    // a hashset and return that back to the index controller and assign that to a preperty on
    // the view model of recipes and finally recipes were displayed via thyeleaf 
    ...
    private List<Recipe> getRecipes() {
        ...
        if(!eachUomOptional.isPresent()){ // if it is not pressent!!!!
        ...
        // Note that this is bidirectional, set for both
